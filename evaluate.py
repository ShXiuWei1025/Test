...
import sys
sys.path.insert(0, './modified_nuscenes')
...
# from modified_nuscenes.loaders import load_prediction, load_gt, add_center_dist, filter_eval_boxes
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_path', type=str, default='./data/submission.json', help='The submission as a JSON file.')
    parser.add_argument('--output_dir', type=str, default='./nuscenes-metrics',
                        help='Folder to store result metrics, graphs and example visualizations.')
    parser.add_argument('--eval_set', type=str, default='mini_val',
                        help='Which dataset split to evaluate on, train, val or test.')
    parser.add_argument('--dataroot', type=str, default='./nuscenes/v1.0-trainval',
